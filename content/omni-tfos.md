...
count: false
![:scale 80%](../../../css/images/TerraformLogo.png)
.titletext[
Hashicorp Terraform Workshop]
Build Cloud Based Resources With Infrastructure as Code

???
<!---
Terraform Vault Workshop - Part 1
...
Welcome to the beginner's guide to Terraform. This slide deck is written entirely in Markdown language, which means you can make edits or additions, then submit a pull request to add your changes to the master copy. To make edits to the slide deck simply fork this repository:  
...
Let's look at a few different ways you could provision a new Virtual Machine. Before we start we'll need to gather some basic information including:
...
???
**Has anyone got experience using cloud platforms? How do most of us normally get started? That's right, we log onto the portal and start clicking around. All of the major cloud providers make this part really easy. You get your account, log on and start clicking buttons. Let's take a peek at what that looks like...**

---
name: AWS-Console-Provision
Method 1: GUI (AWS Console)
-------------------------
![:scale 80%](../../../css/images/aws/AWS_provision.png)
...
Method 1: GUI (Azure Portal)
-------------------------
![:scale 100%](../../../css/images/azure/azure_provision.png)
...
---
name: Templating-AWS-Cloud-Formation
Method 2:  Templating (AWS CloudFormation)
-------------------------
```json
{
...
...
Method 2: Templating (Azure Resource Manager (ARM) Template)
-------------------------
```json
{
...
...
Method 2: Template (GCP Cloud Deployment Manager)
-------------------------
```yaml
resources:
- name: the-first-vm
...
```
.center[Example terraform code for building an VM.]
...
-------------------------
<br><br>
.center[![:scale 100%](../../../css/images/all_clouds.png)]
...
Terraform code (HCL) is easy to learn and easy to read. It also can be up to 50-70% more compact than an equivalent cloud templates.
...
https://aws.amazon.com/blogs/apn/terraform-beyond-the-basics-with-aws/</br>
https://docs.microsoft.com/en-us/azure/terraform/</br>
https://cloud.google.com/community/tutorials/getting-started-on-gcp-with-terraform<br>

Terraform Provider Documentation  
https://www.terraform.io/docs/providers/aws/index.html</br>
https://www.terraform.io/docs/providers/azurerm/</br>
https://www.terraform.io/docs/providers/google/index.html</br>
...
-------------------------
<br><br><br>
You can try the [Introduction to Vault](workshop.html?content=omni-vault.md) Workshop, or proceed to the [Intro to Terraform Enterprise](workshop.html?content=omni-tfe.md) Workshop.
...
[Introduction to Vault](workshop.html?content=omni-vault.md) - Learn the Basics of HashiCorp Vault

[Intro to Terraform Enterprise](workshop.html?content=omni-tfe.md) - Explore Terraform Cloud and Enterprise
