...
![:scale 40%](../../../css/images/azure/AzureLogo.png)
.titletext[
...
Method 1: GUI (Azure Portal)
-------------------------
![:scale 100%](../../../css/images/azure/azure_provision_3.png)
...
-------------------------
<br><br>
.center[![:scale 100%](../../../css/images/azure/azure-cloud.png)]
...
Why Terraform?
-------------------------
![:scale 100%](../../../css/images/azure/azure-loves-terraform.png)
...
RDP is installed by default on almost all Windows corporate PCs and laptops.
...
What Did We Build?
-------------------------
.center[![:scale 60%](../../../css/images/blast_radius_graph_1.png)]
...
Expanding the Graph
-------------------------
.center[![:scale 50%](../../../css/images/blast_radius_graph_3.png)]
...
Terraform Graph
-------------------------
.center[![:scale 70%](../../../css/images/blast_radius_graph_2.png)]
...
-------------------------
<br><br><br>
You can try the [Introduction to Vault](workshop.html?content=azure-vault.md) Workshop, or proceed to the [Intro to Terraform Enterprise](workshop.html?content=azure-tfe.md) Workshop.
...
[Introduction to Vault](workshop.html?content=azure-vault.md) - Learn the Basics of HashiCorp Vault

[Intro to Terraform Enterprise](workshop.html?content=azure-tfe.md) - Explore Terraform Cloud and Enterprise
