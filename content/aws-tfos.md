...
![:scale 40%](../../../css/images/aws/AWSLogo.png)
.titletext[
...
-------------------------
<br><br>
.center[![:scale 100%](../../../css/images/aws/aws-cloud.png)]
...
???
**Here we have pinned the provider version to 2.0 We recommend pinning your provider versions, especially in production.**
...
-------------------------
<br><br><br>
You can try the [Introduction to Vault](workshop.html?content=aws-vault.md) Workshop, or proceed to the [Intro to Terraform Enterprise](workshop.html?content=aws-tfe.md) Workshop.
...
[Introduction to Vault](workshop.html?content=aws-vault.md) - Learn the Basics of HashiCorp Vault

[Intro to Terraform Enterprise](workshop.html?content=aws-tfe.md) - Explore Terraform Cloud and Enterprise
